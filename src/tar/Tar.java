...
public class Tar {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (Objects.equals(args.length, 2) && args[0].equals("-u")) {
            ...
            toWrite(contents, new ArrayList<>(), "");
    ...
    private static void toWrite(Map<String, ArrayList<String>> contents, List<Integer> sizes, String outputName) throws IOException {
